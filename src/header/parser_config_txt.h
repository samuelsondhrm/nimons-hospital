...
#include "ADT/penyakit_dan_obat.h" // Definisi Inventory, Pasien, Obat, dll
#include "ADT/user.h"   // Definisi User, ListUser, dll
...
boolean isDokter(ListUser accounts, int userId);
